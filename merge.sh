...
python3 merge.py kancolle_additional.txt kancolle_correction.txt KanColleDIC_rev64.txt KanColleDic_203.txt kancolle-dic-20171212.txt KanColleDic_208.txt | iconv -f utf-8 -t utf-16le | perl -pe 'BEGIN{print"\xFF\xFE"}' > kancolle.txt
